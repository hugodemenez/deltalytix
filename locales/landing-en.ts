...
export default {
  ...
  "support.pageTitle": "Support Assistant",
  "support.generating": "Generating response…",
  "support.suggestionImport": "Help with importing trades",
  "support.suggestionBilling": "Billing or subscription question",
  "support.suggestionBug": "Report a bug or issue",
  "support.suggestionHuman": "Talk to a human",
  "support.inputPlaceholder": "Describe your issue here…",
  support: {
    greeting:
