export default {
  embed: {
    ...
    pnlPerContract: {
      ...
      description: 'Average net profit/loss per contract by trading instrument (after commissions)',
      tooltip: {
    ...
    pnlPerContractDaily: {
      ...
      description: 'Average net profit/loss per contract per day for selected instrument (after commissions)',
      tooltip: {
        date: 'Date',
        averagePnl: 'Avg Net P/L per contract',
        totalPnl: 'Total Net P/L',
    ...
    contracts: {
      ...
      description: 'Showing total number of contracts traded for each hour of the day. Darker bars indicate more trades.',
      tooltip: {
        hour: 'h',
        totalContracts: 'Total Contracts',
