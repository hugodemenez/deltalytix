export default {
    pricing: {
        ...
        basic: {
            name: 'Basic',
            description: 'Perfect for trying out Deltalytix and getting started with a trading journal.',
    ...
    billing: {
        ...
        subscriptionResumed: 'Your subscription will continue',
        cancelError: 'Failed to cancel subscription. Please try again.',
        resumeError: 'Failed to resume subscription. Please try again.',
        switching: 'Switching...',
