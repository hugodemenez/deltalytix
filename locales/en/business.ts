export default {
  'business.title': 'Turn Trading Data Into Profit',
  'business.description': 'Finally, see exactly which traders make money & why. Real-time analytics that trading firms use to boost profits by 34%.',
  ...
  'business.hero.subtitle': 'Stop guessing. Start profiting. The analytics platform trading firms use to scale faster.',
  ...
  'business.testimonials.role1': 'Head of Trading, Quantum Capital',
  
  'business.testimonials.quote2': 'Finally caught a trader going rogue before he blew up his account. The real-time alerts saved us $2.3M.',
  'business.testimonials.author2': 'Michael Rodriguez',
  'business.testimonials.role2': 'CTO, PropTrade Solutions',
  
  'business.testimonials.quote3': 'Compliance reports that used to take 3 days now take 10 minutes. Our auditors love the transparency.',
  ...
  'business.cta.contact.title': 'Questions? We Have Answers',
  'business.cta.contact.description': 'Talk to someone who actually understands trading analytics.',
  ...
  'business.usecases.fund.description': 'Transparent reporting for investors. Attribution analysis that actually makes sense. Performance tracking that builds trust.',
  
  'business.usecases.prop.title': 'Proprietary Trading Firms',
  'business.usecases.prop.description': 'Scale from 10 to 1,000 traders without losing control. Spot winning strategies and eliminate losing ones.',
  
  'business.usecases.family.title': 'Family Offices',
  'business.usecases.family.description': 'Sophisticated analytics for complex strategies. The transparency and control that family wealth deserves.',
  
  'business.usecases.institutional.title': 'Institutional Trading Desks',
  ...
  'business.roadmap.coming': 'Coming Soon',
  'business.roadmap.inProgress': 'In Progress',
  ...
  'business.rename.error': 'Failed to rename business',
  'business.rename.nameExists': 'A business with this name already exists',
  'business.rename.nameRequired': 'Business name is required',
  'business.rename.onlyOwner': 'Only business owners can rename businesses',
  ...
  'business.traders.add.error': 'Failed to add trader',
  'business.traders.add.userNotFound': 'User with this email not found',
  'business.traders.add.alreadyMember': 'Trader is already a member of this business',
  'business.traders.add.unauthorized': 'Only business owners and admin managers can add traders',
  'business.traders.add.emailRequired': 'Trader email is required',
  ...
  'business.invitations.expired': 'Invitation has expired',
  'business.invitations.alreadyAccepted': 'Invitation already accepted',
  'business.invitations.invalidToken': 'Invalid invitation token',
  
  // Join business
  'business.join.success': 'Successfully joined business',
  'business.join.error': 'Failed to join business',
  'business.join.invalidInvitation': 'Invalid invitation',
  'business.join.expiredInvitation': 'Invitation has expired',
  'business.join.alreadyMember': 'You are already a member of this business',
  'business.invitations.alreadySent': 'An invitation has already been sent to this email',
  'business.invitations.accepted': 'Invitation accepted successfully',
  'business.invitations.declined': 'Invitation declined',
  ...
  // Equity dashboard
  'business.equity.dailyView': 'Daily View',
  'business.equity.tradeView': 'Trade View',
  'business.equity.groupedByDay': 'Grouped by day',
  ...
  'business.equity.negative': 'Negative',
  'business.equity.showingResults': 'Showing {filtered} of {total} users',
  'business.equity.filteredFrom': 'filtered from',
  'business.equity.total': 'total',
  'business.equity.traderNumber': 'Trader #{number}',
  'business.equity.tradeStats': '{days} days, {trades} trades',
  'business.equity.viewTraderDetails': 'View trader details',
  'business.equity.trades': 'Trades',
  'business.equity.winRate': 'Win Rate',
  'business.equity.avgWin': 'Avg Win',
  'business.equity.wins': 'Wins',
  'business.equity.losses': 'Losses',
  'business.equity.avgLoss': 'Avg Loss',
  'business.equity.maxDD': 'Max DD',
  'business.equity.profitFactor': 'P.Factor',
  'business.equity.scrollToLoadMore': 'Scroll to load more...',
  'business.equity.noMoreUsers': 'No more users to load',
  'business.equity.noUsersFound': 'No users found',
  'business.equity.exportTrades': 'Export All Trades',
  'business.equity.exporting': 'Exporting...',
  'business.equity.exportSuccess': 'Trades exported successfully',
  'business.equity.exportError': 'Failed to export trades',
  ...
  'business.management.manageTitle': 'Manage - {name}',
  'business.management.manageDescription': 'Manage your business settings, rename, traders, and managers',
  'business.management.rename': 'Rename',
  'business.management.close': 'Close',
  'business.management.created': 'Created',
  'business.management.member': 'Member',
  'business.management.pending': 'Pending',
  'business.management.active': 'Active',
  ...
  'business.management.teamCollaboration': 'Team collaboration',
