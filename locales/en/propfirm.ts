    ...
    propFirm: {
        ...
        configurator: {
            ...
            template: {
                ...
                duplicateError: 'Template already exists',
                duplicateErrorDescription: 'A template named "{name}" with the same account size label already exists.',
            ...
            fields: {
                ...
                propfirmSharingPercentage: 'Prop Firm Sharing %',
