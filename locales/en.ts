...
export default {
    ...
    'trade-table.addTag': 'Add "{tag}"',
    'trade-table.existingTags': 'Existing Tags',
    'trade-table.entryPrice': 'Entry Price',
    'trade-table.exitPrice': 'Exit Price',
    'trade-table.trades': 'trade',
    'trade-table.trades_plural': 'trades',
    'trade-table.comment': 'Comment',
    'trade-table.addComment': 'Add comment',
    'trade-table.videoUrl': 'Video URL',
    'trade-table.addVideoUrl': 'Add video URL',
    'trade-table.invalidVideoUrl': 'Please enter a valid video URL (YouTube, TradingView, or direct video file)',
