...
export default {
  ...
  "docs.openapi.title": "OpenAPI reference",
  "docs.openapi.description":
    "Paths, methods, parameters, and response codes from the live OpenAPI document.",
  "docs.openapi.download": "Download openapi.json",
  "docs.openapi.loading": "Loading OpenAPI document…",
  "docs.openapi.error": "Could not load the OpenAPI document.",
  "docs.openapi.retry": "Retry",
  "docs.openapi.empty": "No paths found in the OpenAPI document.",
  "docs.openapi.parameters": "Parameters",
  "docs.openapi.requestBody": "Request body",
  "docs.openapi.responses": "Responses",
  "docs.openapi.required": "required",
  "docs.openapi.noSummary": "No summary",
  ...
  "docs.playground.generating": "Generating…",
  "docs.playground.revoke": "Revoke",
  "docs.playground.clear": "Clear",
  "docs.playground.copy": "Copy",
  "docs.playground.copied": "Copied",
  "docs.playground.signIn": "Sign in to generate a token",
  "docs.playground.signInHint":
    "Or paste a personal access token from Dashboard → Developers.",
  "docs.playground.pasteToken": "Bearer token",
  "docs.playground.pastePlaceholder": "dltx_pat_…",
  "docs.playground.writeScopes": "Optional write scopes",
  "docs.playground.endpoint": "Endpoint",
  "docs.playground.method": "Method",
  "docs.playground.path": "Path",
  "docs.playground.body": "JSON body",
  "docs.playground.send": "Send",
  "docs.playground.sending": "Sending…",
  "docs.playground.response": "Response",
  "docs.playground.noToken": "Add a bearer token before sending a request.",
  ...
  "connections.strip.deleteConfirmDescription":
    "This permanently deletes {account} and its trades.",
  "connections.strip.deleteConfirmAction": "Delete account",
  "connections.strip.renameFailed": "Unable to rename account",
  "connections.strip.maskFailed": "Unable to update mask",
  "connections.strip.deleteFailed": "Unable to delete account",
  "connections.strip.duplicateNumber": "That account number is already in use",
  "connections.strip.accountDeleted": "Account {account} deleted",
  ...
  filters: {
    ...
    addFilterAriaCount: "Filters, {count} active",
