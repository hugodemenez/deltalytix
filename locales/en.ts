...
export default {
  ...
  "updates.description":
    "Follow the latest features, improvements, and fixes we're shipping to make Deltalytix a better home for your trading data.",
  ...
  "connections.standaloneEmpty": "No standalone accounts. Import a file or enter trades manually.",
  "connections.standaloneHint": "Imported without a broker sync",
  "connections.lastSynced": "Last synced {time}",
  "connections.neverSynced": "Never synced",
  "connections.accountCount.one": "{count} account",
  "connections.accountCount.other": "{count} accounts",
  "connections.showMoreAccounts.one": "Show {count} more account",
  "connections.showMoreAccounts.other": "Show {count} more accounts",
  "connections.showFewerAccounts": "Show fewer",
  ...
  "connections.deleteConfirmDescription":
    "This removes the broker link. Hosted accounts become standalone; trades are kept.",
  ...
  "connections.oauth.tradovate.errorRegistered":
    "Tradovate connection saved with an error: {reason}",
  "connections.oauth.tradovate.unknownError": "Tradovate authentication failed",
  "connections.oauth.tradovate.connecting": "Connecting Tradovate…",
  ...
  "dashboard.billingPage.freeCadenceNote":
    "Quarterly · Yearly · Lifetime · Cancel anytime",
  ...
  "dashboard.settings.page.emailLocked": "Can't change here",
  "dashboard.settings.page.updateProfile": "Update profile",
  "dashboard.settings.page.preferences": "Preferences",
  "dashboard.settings.page.themeHint": "Light, dark, or system",
  "dashboard.settings.page.themeLight": "Light",
  "dashboard.settings.page.themeDark": "Dark",
  "dashboard.settings.page.themeSystem": "System",
  "dashboard.settings.page.themeIntensity": "Theme intensity",
  "dashboard.settings.page.firstName": "First name",
  "dashboard.settings.page.lastName": "Last name",
  "dashboard.settings.page.notifications": "Notifications",
  "dashboard.settings.page.emailNotifications": "Email notifications",
  "dashboard.settings.page.pushNotifications": "Push notifications",
  "dashboard.settings.page.tradingAlerts": "Trading alerts",
  "dashboard.settings.page.weeklyReports": "Weekly reports",
  "dashboard.settings.page.teamInviteHint": "Ask your admin for an invite.",
  "dashboard.settings.page.manageTeams": "Manage teams",
  "dashboard.settings.page.account": "Account",
  "dashboard.settings.page.billing": "Billing & subscription",
  "dashboard.settings.page.data": "Data management",
  "dashboard.settings.page.support": "Support & help",
  "dashboard.settings.page.signOut": "Sign out",
  "dashboard.settings.page.password": "Password",
  "dashboard.settings.page.newPassword": "New password",
  "dashboard.settings.page.confirmPassword": "Confirm password",
  "dashboard.settings.page.setPassword": "Set password",
  "dashboard.settings.page.linkedAccounts": "Linked accounts",
  "dashboard.settings.page.signInStatus": "Sign-in",
  "dashboard.settings.page.notLinked": "Not linked",
  "dashboard.settings.page.linked": "Linked",
  "dashboard.settings.page.link": "Link",
  "dashboard.settings.page.breakevenHint": "Min / max P&L window",
  "dashboard.settings.page.active": "Active",
  ...
  "import.processed.title": "Processed trades",
  "import.processed.totalPnl": "Total PnL",
  "import.processed.totalCommission": "Total commission",
  "import.processed.instruments": "Instruments traded",
  "import.processed.columns.instrument": "Instrument",
  "import.processed.columns.side": "Side",
  "import.processed.columns.quantity": "Quantity",
  "import.processed.columns.entryPrice": "Entry price",
  "import.processed.columns.closePrice": "Close price",
  "import.processed.columns.entryDate": "Entry date",
  "import.processed.columns.closeDate": "Close date",
  "import.processed.columns.pnl": "PnL",
  "import.processed.columns.timeInPosition": "Time in position",
  ...
  "import.type.rithmicOrders.description": "Rithmic Orders CSV",
  ...
  "import.type.ninjaTrader.description": "NinjaTrader Performance CSV",
  "import.type.tradezella.name": "TradeZella",
  "import.type.tradezella.description": "TradeZella Excel file",
  "import.type.tradovate.name": "Tradovate",
  "import.type.tradovate.description": "Tradovate CSV file",
  "import.type.quantower.name": "Quantower",
  "import.type.quantower.description": "Quantower CSV file",
  ...
  "import.type.tutorial.open": "Tutorial",
  "import.type.tutorial.redirectTitle": "Open external tutorial?",
  "import.type.tutorial.redirectDescription":
    "No in-app video is available for {platform}. Continue to the official documentation in a new tab?",
  "import.type.tutorial.redirectConfirm": "Open tutorial",
  "import.type.tutorial.downloadSample": "Download sample file",
  ...
  "widgets.types.profitFactor": "Profit Factor",
  "widgets.types.riskRewardRatio": "Risk/Reward Ratio",
  "widgets.types.propFirm": "Accounts",
  "widgets.types.tradeDistribution": "Trade Distribution",
  "widgets.types.timeRangePerformance": "Time Range Performance",
  "widgets.types.mindsetWidget": "Mindset",
  "widgets.mobile.deleteDialogTitle": "Remove widget",
  ...
  "share.exportPdfError": "Failed to generate the dashboard statement PDF",
  "share.pdfStatementTitle": "Trading Performance Statement",
  "share.pdfStatementSubtitle": "Formatted summary of your dashboard performance",
  "share.pdfGeneratedOn": "Generated on",
  ...
  "share.pdfDashboardSnapshotTitle": "Dashboard Overview",
  "share.pdfChartFallbackTitle": "Chart Widget",
  "share.pdfFooterTitle": "Deltalytix Statement",
  "share.pdfPage": "Page",
  "share.pdfTotalTrades": "Total trades",
  ...
  rithmic: {
    ...
    balances: {
      ...
      debug: {
        ...
        description:
          "Diagnostic info for Rithmic balance fetching. Copy the report and share it for troubleshooting.",
        copy: "Copy report",
        copied: "Debug report copied to clipboard",
        copyFailed: "Failed to copy debug report",
        config: "Configuration",
        fetchAttempts: "Fetch attempts",
        accounts: "Dashboard accounts",
        rawReport: "Raw report (JSON)",
        noAttempts: "No fetch attempts yet.",
        noDashboardAccounts: "No dashboard accounts to compare.",
        apiConfigured: "API configured",
        apiMissing: "API missing",
        credentialsFound: "Credentials found",
        credentialsMissing: "No credentials",
        balancesFound: "Balances returned",
        balancesMissing: "No balances",
        linked: "Linked",
        fetched: "Fetched",
  ...
  "import.type.pdfImport": {
    name: "PDF Import",
    description: "IBKR PDF statement",
    details:
  ...
  "accounts.mobile.reorderAccount": "Reorder account {accountNumber}",
  "accounts.card.openAccount": "Open {accountName}",
  "accounts.toolbar.searchAccounts": "Search accounts",
  "accounts.toolbar.searchPlaceholder": "Search account or prop firm...",
  "accounts.toolbar.noResults": "No accounts found",
  "accounts.toolbar.createGroup": "Create group",
  "accounts.toolbar.createGroupDescription": "Give your new account group a name.",
  "accounts.toolbar.groupNamePlaceholder": "Group name",
  "accounts.toolbar.createGroupSuccess": "Group \"{name}\" created",
  "accounts.toolbar.createGroupError": "Failed to create group",
  "accounts.toolbar.editGroups": "Edit groups",
