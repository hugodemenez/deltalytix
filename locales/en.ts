...
export default {
  ...
  "dashboard.settings.breakeven.description": "Define the P&L range that counts as a breakeven trade. Trades with P&L within this range will be classified as breakeven instead of win or loss.",
  ...
  "dashboard.settings.breakeven.example": "Example: Setting -10 to 10 means any trade with P&L between -$10 and $10 is breakeven.",
