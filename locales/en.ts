...
export default {
    ...
    'import.type.rithmicOrders.details': 'Following fields are mandatory: Account, Buy/Sell, Avg Price, Symbol, Update time, Qty, Commission rate',
    ...
    'equity': {
        ...
        legend: {
            ...
            confirm: 'Confirm',
            maxAccountsInfo: 'Maximum 10 accounts can be displayed simultaneously for optimal performance'
        }
    },
    ...
    'pnlPerContract.description': 'Average net profit/loss per contract by trading instrument (after commissions)',
    ...
    'pnlPerContractDaily.description': 'Average net profit/loss per contract per day for selected instrument (after commissions)',
    ...
    'trade-table': {
        ...
        'deleteErrorDescription': 'An error occurred while deleting the trades. Please try again.',
    ...
    'tradovateSync': {
        ...
        'sync': {
            ...
            'accountProgress': 'Found {ordersCount} orders, saved {savedCount} new trades',
            'syncComplete': '✅ Sync Complete',
            'syncCompleteWithTrades': 'Processed {totalOrdersProcessed} orders and saved {totalTradesSaved} new trades',
            'syncCompleteNoNewTrades': '🔄 Sync Complete',
            'syncCompleteNoNewTradesDesc': 'Processed {totalOrdersProcessed} orders (no new trades - likely duplicates)',
            'syncCompleteNoOrders': '📭 Sync Complete',
            'syncCompleteNoOrdersDesc': 'No new orders found in the last 30 days (API doesn\'t provide more than 1 day of history)',
        ...
        'multiAccount': {
            ...
            'addNewAccountDescription': 'Connect a new Tradovate account by providing a name for it.',
            ...
            'existingConnectionsDescription': 'You have {count} saved account connection(s).',
            'syncAccount': 'Sync',
            'tokenNotFound': 'Token Not Found',
            'tokenNotFoundDescription': 'No valid token found for account: {accountId}',
            'syncCompleteForAccount': 'Successfully synced {savedCount} trades from {ordersCount} orders for {accountId}.',
            'alreadyImportedTrades': 'Trades already imported',
            'syncCompleteNoNewTradesForAccount': 'Processed {ordersCount} orders for {accountId} but no new trades were found.',
            ...
            'deleteAccountConfirm': 'Are you sure you want to delete the account "{accountId}"? This action cannot be undone.',
