export default {
  embed: {
    ...
    descriptions: {
      ...
      pnlBySide:
        "So sánh hiệu suất long vs short. Chuyển đổi giữa trung bình/tổng.",
      dailyPnl:
      ...
      timeInPosition: "Thời gian các vị thế thường được giữ trước khi đóng.",
      tradeDistribution:
    ...
    pnlPerContract: {
      ...
      description:
        "Lợi nhuận/thua lỗ ròng trung bình trên mỗi hợp đồng theo công cụ giao dịch (sau hoa hồng)",
      tooltip: {
    ...
    pnlPerContractDaily: {
      ...
      description:
        "Lợi nhuận/thua lỗ ròng trung bình trên mỗi hợp đồng mỗi ngày cho công cụ đã chọn (sau hoa hồng)",
      tooltip: {
        date: "Ngày",
        averagePnl: "P&L Ròng TB Trên Mỗi Hợp Đồng",
        totalPnl: "Tổng P&L Ròng",
    ...
    contracts: {
      ...
      description:
        "Hiển thị tổng số hợp đồng được giao dịch cho mỗi giờ trong ngày. Thanh tối hơn cho thấy nhiều giao dịch hơn.",
      tooltip: {
        hour: "h",
        totalContracts: "Tổng Hợp Đồng",
    ...
    timeRangePerformance: {
      ...
      tooltip: {
        ...
        winRate: "Tỷ lệ thắng",
        "trades#zero": "Không có giao dịch",
        "trades#one": "1 giao dịch",
        "trades#other": "{count} giao dịch",
      },
      ranges: {
        under1min: "< 1m",
        "1to5min": "1-5m",
