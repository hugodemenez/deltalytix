const embed = {
  embed: {
    ...
    descriptions: {
      timeRangePerformance: "显示按持仓时间分组的交易的平均盈亏和胜率",
      pnlBySide: "比较做多与做空的表现。在平均值/总计之间切换。",
      dailyPnl: "从交易中汇总的每日总盈亏。工具提示显示做多/做空计数。",
      timeOfDay: "一天中各小时的表现分布，以揭示最佳交易时段。",
      timeInPosition: "仓位在关闭前通常持有的时间。",
      tradeDistribution: "按盈亏分布的交易以可视化偏度和尾部。",
      weekdayPnl: "按星期几的平均表现以识别每周模式。",
      pnlPerContract: "按工具/合约分组的表现以比较优势。",
      pnlPerContractDaily: "所选工具/合约的每日盈亏明细。",
      tickDistribution: "以点数表示的盈亏直方图，用于分析交易结果的分散度。",
      commissionsPnl: "佣金对盈亏的影响以了解净盈利能力。",
      contractQuantity: "各交易的持仓规模（数量）分布。",
    },
