...
export default {
    ...
    'pricing.billedQuarterly': '€{total} facturé trimestriellement',
    ...
    'filters.newGroup': 'Nom du nouveau groupe',
    'filters.createGroup': 'Créer un groupe',
    'filters.noGroup': 'Sans groupe',
    'filters.groupCreated': 'Groupe "{name}" créé avec succès',
    'filters.errorCreatingGroup': 'Échec de la création du groupe "{name}"',
    'filters.groupUpdated': 'Groupe "{name}" mis à jour avec succès',
