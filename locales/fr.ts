...
export default {
  ...
  "dashboard.billingSheet.currentPlan": "Offre actuelle",
  "dashboard.billingSheet.limitedWidgets": "Widgets limités",
  "dashboard.billingSheet.fullAccess": "Accès complet",
  "dashboard.billingSheet.lifetimePaid": "Payé une fois · aucun renouvellement",
  "dashboard.billingSheet.availablePlans": "Offres disponibles",
  "dashboard.billingSheet.availableChanges": "Changements d’offre disponibles",
  "dashboard.billingSheet.monthlyDetail": "Tous les widgets, renouvelé chaque mois",
  "dashboard.billingSheet.quarterlyDetail": "Facturé tous les 3 mois",
  "dashboard.billingSheet.yearlyDetail": "Meilleur tarif annuel",
  "dashboard.billingSheet.lifetimeDetail": "Payez une fois, conservez à vie",
  "dashboard.billingSheet.save": "Économisez",
  "dashboard.billingSheet.bestValue": "Meilleure offre",
  "dashboard.billingSheet.upgradeToPeriod": "Passer à Plus · {period}",
  "dashboard.billingSheet.changeToPeriod": "Changer pour Plus · {period}",
  "dashboard.billingSheet.allSet": "Tout est en ordre",
  "dashboard.billingSheet.lifetimeIncludesFuture":
    "L’accès à vie inclut toutes les futures fonctionnalités Plus",
  "dashboard.billingSheet.noLifetimeChangesTitle": "L’offre à vie est votre offre maximale",
  ...
  "dashboard.billing.manage": "Facturation",
  ...
  "dashboard.billingPage.freeCadenceNote":
    "Trimestriel · Annuel · À vie · Annulable à tout moment",
  ...
  "dashboard.settings.breakeven.description": "Définissez la plage de P&L net (après commissions) considérée comme un trade à l'équilibre. Les trades dont le P&L net se situe dans cette plage seront classés comme breakeven au lieu de gain ou perte.",
  "dashboard.settings.breakeven.min": "Min",
  "dashboard.settings.breakeven.max": "Max",
  "dashboard.settings.breakeven.reset": "Réinitialiser",
  "dashboard.settings.breakeven.invalidMin": "Le minimum doit être un nombre inférieur ou égal au maximum.",
  "dashboard.settings.breakeven.invalidMax": "Le maximum doit être un nombre supérieur ou égal au minimum.",
  "dashboard.settings.breakeven.example": "Exemple : Définir -10 à 10 signifie que tout trade avec un P&L net entre -10$ et 10$ est considéré breakeven.",
  "dashboard.settings.page.emailLocked": "Impossible de modifier ici",
  "dashboard.settings.page.updateProfile": "Mettre à jour le profil",
  "dashboard.settings.page.preferences": "Préférences",
  "dashboard.settings.page.themeHint": "Clair, sombre ou système",
  "dashboard.settings.page.themeLight": "Clair",
  "dashboard.settings.page.themeDark": "Sombre",
  "dashboard.settings.page.themeSystem": "Système",
  "dashboard.settings.page.themeIntensity": "Intensité du thème",
  "dashboard.settings.page.firstName": "Prénom",
  "dashboard.settings.page.lastName": "Nom",
  "dashboard.settings.page.notifications": "Notifications",
  "dashboard.settings.page.emailNotifications": "Notifications par email",
  "dashboard.settings.page.pushNotifications": "Notifications push",
  "dashboard.settings.page.tradingAlerts": "Alertes de trading",
  "dashboard.settings.page.weeklyReports": "Rapports hebdomadaires",
  "dashboard.settings.page.teamInviteHint": "Demandez une invitation à votre admin.",
  "dashboard.settings.page.manageTeams": "Gérer les équipes",
  "dashboard.settings.page.account": "Compte",
  "dashboard.settings.page.billing": "Facturation et abonnement",
  "dashboard.settings.page.data": "Gestion des données",
  "dashboard.settings.page.support": "Aide et support",
  "dashboard.settings.page.signOut": "Se déconnecter",
  "dashboard.settings.page.password": "Mot de passe",
  "dashboard.settings.page.newPassword": "Nouveau mot de passe",
  "dashboard.settings.page.confirmPassword": "Confirmer le mot de passe",
  "dashboard.settings.page.setPassword": "Définir le mot de passe",
  "dashboard.settings.page.linkedAccounts": "Comptes liés",
  "dashboard.settings.page.signInStatus": "Connexion",
  "dashboard.settings.page.notLinked": "Non lié",
  "dashboard.settings.page.linked": "Lié",
  "dashboard.settings.page.link": "Lier",
  "dashboard.settings.page.breakevenHint": "Fenêtre min / max du P&L",
  "dashboard.settings.page.active": "Actif",
  ...
  equity: {
    ...
    legend: {
      ...
      confirm: "Confirmer",
      selectionSummary: "{selected} sur {total} sélectionnés, max {max}",
      maxAccountsInfo: "Au plus {max} comptes peuvent être affichés",
    },
  },
  ...
  rithmic: {
    ...
    balances: {
      ...
      debug: {
        ...
        description:
          "Informations de diagnostic pour la récupération des soldes Rithmic. Copiez le rapport pour le partager.",
        copy: "Copier le rapport",
        copied: "Rapport de debug copié",
        copyFailed: "Échec de la copie du rapport",
        config: "Configuration",
        fetchAttempts: "Tentatives de récupération",
        accounts: "Comptes du dashboard",
        rawReport: "Rapport brut (JSON)",
        noAttempts: "Aucune tentative pour le moment.",
        noDashboardAccounts: "Aucun compte dashboard à comparer.",
        ...
        balancesFound: "Soldes reçus",
        balancesMissing: "Aucun solde",
        linked: "Lié",
        fetched: "Récupéré",
        visible: "Visible dans l'UI",
      },
    },
  },
  ...
  "share.pdfDashboardSnapshotTitle": "Vue d'ensemble du dashboard",
  ...
  "accounts.mobile.reorderAccount": "Réordonner le compte {accountNumber}",
  "accounts.card.openAccount": "Ouvrir {accountName}",
  "accounts.toolbar.searchAccounts": "Rechercher des comptes",
  "accounts.toolbar.searchPlaceholder": "Rechercher un compte ou une prop firm...",
  "accounts.toolbar.noResults": "Aucun compte trouvé",
  "accounts.toolbar.createGroup": "Créer un groupe",
  "accounts.toolbar.createGroupDescription": "Donnez un nom à votre nouveau groupe de comptes.",
  "accounts.toolbar.groupNamePlaceholder": "Nom du groupe",
  "accounts.toolbar.createGroupSuccess": "Groupe « {name} » créé",
  "accounts.toolbar.createGroupError": "Échec de la création du groupe",
  "accounts.toolbar.editGroups": "Modifier les groupes",
