...
export default {
    ...
    'tradovateSync': {
        ...
        'sync': {
            ...
            'accountProgress': 'Trouvé {fillsCount} ordres, sauvegardé {savedCount} nouveaux trades',
            'syncComplete': '✅ Synchronisation Terminée',
            'syncCompleteWithTrades': 'Traité {totalFillsProcessed} ordres et sauvegardé {totalTradesSaved} nouveaux trades',
            'syncCompleteNoNewTrades': '🔄 Synchronisation Terminée',
            'syncCompleteNoNewTradesDesc': 'Traité {totalFillsProcessed} ordres (aucun nouveau trade - probablement des doublons)',
            'syncCompleteNoFills': '📭 Synchronisation Terminée',
            'syncCompleteNoFillsDesc': 'Aucun nouvel ordre trouvé dans les 30 derniers jours (l\'API ne fournit pas plus d\'1 jour d\'historique)',
