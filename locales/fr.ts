...
export default {
  ...
  "dashboard.settings.breakeven.description": "Définissez la plage de P&L considérée comme un trade à l'équilibre. Les trades dont le P&L se situe dans cette plage seront classés comme breakeven au lieu de gain ou perte.",
  ...
  "dashboard.settings.breakeven.example": "Exemple : Définir -10 à 10 signifie que tout trade avec un P&L entre -10$ et 10$ est considéré breakeven.",
