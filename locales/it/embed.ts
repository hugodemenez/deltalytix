const embed = {
  embed: {
    ...
    descriptions: {
      ...
      pnlBySide:
        "Confronta le prestazioni long vs short. Alterna tra media/totale.",
      dailyPnl:
      ...
      contractQuantity:
        "Distribuzione delle dimensioni delle posizione (quantità) tra le operazioni.",
    },
    ...
    pnlPerContract: {
      ...
      description:
        "Profitto/perdita netto medio per contratto per strumento di trading (dopo commissioni)",
      tooltip: {
    ...
    pnlPerContractDaily: {
      ...
      description:
        "Profitto/perdita netto medio per contratto al giorno per strumento selezionato (dopo commissioni)",
      tooltip: {
        date: "Data",
        averagePnl: "P&L Netto Medio per Contratto",
        totalPnl: "P&L Netto Totale",
    ...
    tradeDistribution: {
      title: "Distribuzione delle operazioni",
      description:
        "Distribuzione delle operazioni per esito (vincita/perdita/pareggio)",
      tooltip: {
        type: "Tipo",
        percentage: "Percentuale",
      },
      winTrades: "Operazioni vincenti",
      lossTrades: "Operazioni perdenti",
      breakevenTrades: "Operazioni in pareggio",
    },

    tickDistribution: {
      title: "Distribuzione dei tick",
      description: "Distribuzione delle operazioni per valore di tick",
      tooltip: {
        ticks: "Tick",
        frequency: "Frequenza",
      },
    ...
    commissions: {
      ...
      tooltip: {
        description:
          "Distribuzione del profitto/perdita netto rispetto alle commissioni pagate",
        percentage: "Percentuale",
      },
      legend: {
        netPnl: "P&L Netto",
    ...
    contracts: {
      ...
      description:
        "Mostra il numero totale di contratti negoziati per ogni ora del giorno. Le barre più scure indicano più operazioni.",
      tooltip: {
        hour: "h",
        totalContracts: "Contratti Totali",
    ...
    timeRangePerformance: {
      title: "Prestazioni per intervallo di tempo",
      description: "Prestazioni per intervallo di tempo",
      tooltip: {
        timeRange: "Intervallo di tempo",
        avgPnl: "P/L medio",
        winRate: "Tasso di vincita",
        "trades#zero": "Nessuna operazione",
        "trades#one": "1 operazione",
        "trades#other": "{count} operazioni",
      },
      ranges: {
        under1min: "< 1m",
        "1to5min": "1-5m",
