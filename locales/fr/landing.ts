export default {
  landing: {
    ...
    description:
      "Deltalytix est un journal de trading web pour traders futures permettant de stocker, explorer et comprendre leur historique de trading.",
    cta: "Commencer maintenant",
    demoVideo: "Vidéo de démonstration du produit",
    updates: "Dernières mises à jour du produit →",
    partners: {
      title:
        "Une infrastructure de confiance, portée par les leaders du secteur",
      description:
    ...
    openSource: {
      ...
      description:
        "Nous croyons en la transparence totale. Notre code source est ouvert à tous pour inspection, audit et vérification - garantissant les plus hauts standards de sécurité et de fiabilité.",
      starItToo: "Étoile",
      contributionGraph: {
        previousYear: "Année précédente",
        nextYear: "Année suivante",
        closeWeekDetails: "Fermer les détails de la semaine",
        weekDetails: "Détails de la semaine du {range}",
    ...
    accordion: {
      openSource: {
        title: "Open source",
        description:
          "Notre code source est entièrement ouvert. Inspectez le code, vérifiez nos pratiques de sécurité et contribuez à {repoName}.",
      ...
      openRoadmap: {
        ...
        description:
          "Il manque une fonctionnalité ? Lancez une discussion, signalez un problème, contribuez au code ou même forkez le dépôt.",
        button: "Voir les mises à jour",
      },
      security: {
        title: "Sécurité",
        description:
          "Nous prenons la sécurité au sérieux. Découvrez nos mesures de sécurité et comment signaler les vulnérabilités.",
      },
    ...
    navbar: {
      ...
      dataImportDescription:
        "Importez des données depuis différents fournisseurs.",
      performanceVisualizationDescription:
        "Visualisez vos performances de trading.",
    ...
    consent: {
      record: {
        ...
        sub: "Le site fonctionne dans tous les cas. Ces deux options sont facultatives.",
        productUse: {
    ...
    propfirms: {
      ...
      description:
        "Explorez les prop firms suivies par les utilisateurs de Deltalytix. Consultez les statistiques réelles sur les comptes enregistrés et les performances de payouts.",
