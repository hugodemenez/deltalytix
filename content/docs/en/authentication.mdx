...
The documentation playground can issue a short-lived, read-only demo token without signing in. It authenticates as a shared sample account (`DEMO-001`) so you can try `GET` routes. Write scopes require your own docs token or PAT.
