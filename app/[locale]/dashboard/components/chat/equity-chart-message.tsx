...
export function EquityChartMessage({ 
  ...
  console.log(`[EquityChartMessage] Rendering chart with:`, { chartData, accountNumbers, showIndividual, dateRange, timezone, totalTrades })
  const t = useI18n()
    ...
    <div className="w-full">
      <div className="mb-2 text-sm text-muted-foreground">
        <div className="flex items-center justify-between">
          ...
          <span>
            {t('chat.chart.tradeCount', { count: totalTrades })}
          </span>
        </div>
