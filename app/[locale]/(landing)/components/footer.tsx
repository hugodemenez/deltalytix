...
export default function Footer() {
  ...
  const navigation = {
    ...
    social: [
      { name: 'GitHub', href: 'https://github.com/itskavin/deltalytix', icon: (props: React.SVGProps<SVGSVGElement>) => (
      ...
      { name: 'YouTube', href: 'https://www.youtube.com/@bykavin', icon: (props: React.SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
