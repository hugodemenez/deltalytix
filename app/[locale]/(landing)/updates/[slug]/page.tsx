      ...
      return (
        <>
          ...
          <article className="max-w-4xl mx-auto px-4 pt-16 pb-16 sm:px-6 lg:px-8" itemScope itemType="https://schema.org/Article">
            <UpdatesNavigation previous={previous} next={next} locale={locale} position="top" />
            <div className="mb-8">
              ...
              <h1 className="text-4xl font-bold text-neutral-900 dark:text-neutral-100" itemProp="headline">
                {meta.title}
              </h1>
            </div>
