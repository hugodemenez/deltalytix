...
const app_exe_name = "deltalytix-desktop";
...
pub fn build(b: *std.Build) void {
    ...
    const run_step = b.step("run", "Run the native shell (start the Next.js server separately)");
    ...
    const dev_step = b.step("dev", "Run the Deltalytix dev server and native shell");
